...
void gamma_phsp_vs_isr()
{
    ...
    gStyle->SetOptStat(0);
    string in_1 = "../../root_file/isr/isr_list_gamma_REC.root";
    string in_2 = "../../root_file/nbar_recoil/phsp_list_gamma_REC.root";
    ...
    TFile myf_1("../../root_file/isr/isr_list_gamma_REC.root");
    TFile myf_2("../../root_file/nbar_recoil/phsp_list_gamma_REC.root");
    ...
    histo1->SetTitle("#gamma list REC");
    ...
    tela->Update();
    tela->SaveAs("images/phsp_vs_isr_gammaList_REC.pdf");
...
void nbar_phsp_vs_isr_MC()
{
    ...
    gStyle->SetOptStat(0);
    string in_1 = "../../root_file/isr/isr_list_n_REC.root";
    string in_2 = "../../root_file/nbar_recoil/phsp_list_n_REC.root";
    ...
    TFile myf_1("../../root_file/isr/isr_list_n_REC.root");
    TFile myf_2("../../root_file/nbar_recoil/phsp_list_n_REC.root");
    ...
    histo1->GetXaxis()->SetTitle("#theta [rad]");
    histo1->GetYaxis()->SetTitle("counts []");
    histo1->SetTitle("#bar{n} list REC");
    ...
    tela->Update();
    tela->SaveAs("images/phsp_vs_isr_nList_REC.pdf");
